<template>
    ...
    <section v-else>
        ...
        <table-base
            ...
            :fields="fields"
            :items="items"
            class="tao-table--holders">
            <template
                slot="hash"
                slot-scope="props">
                <nuxt-link
                    :to="{name: 'tokens-slug-trc2-holder', params: { slug: address, holder: props.item.hash}}"
...
export default {
    ...
    methods: {
        async getDataFromApi () {
            ...
            let { data } = await this.$axios.get('/api/token-holders/trc2' + '?' + query)
