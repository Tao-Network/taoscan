<template>
    ...
    <section v-else>
        <div class="card tao-card tao-card--verify">
            <div class="tao-card__header">
                <h3 class="tao-card__headline">Verify and Publish your Solidity Source Code</h3>
            ...
            <div class="tao-card__body">
                ...
                <form
                    :class="loadingForm ? 'tao-loading tao-loading--form' : ''"
                    novalidate
